...
class TestGame:
    ...
    def make_mock_cards(self, num_players=1):
        def mock_cards(*args, **kwargs):
            ...
            match self.call_count:
                ...
                case 1:
                    ret = mock_card_options[cards_for_players:cards_for_players+1]  # burn for flop
                case 2:
                    ret = mock_card_options[cards_for_players+1:cards_for_players+4]  # flop
                case 3:
                    ret = mock_card_options[cards_for_players+4:cards_for_players+5]  # burn for turn
                case 4:
                    ret = mock_card_options[cards_for_players+5:cards_for_players+6]  # turn
                case 5:
                    ret = mock_card_options[cards_for_players+6:cards_for_players+7]  # burn for river
                case 6:
                    ret = mock_card_options[cards_for_players+7:cards_for_players+8]  # river
                case _:
                    ret = []
            self.call_count += 1
            return ret
    ...
    def setup_and_teardown(self):
        ...
        self.call_count = 0
        with patch(
            "random.sample", side_effect=self.make_mock_cards()
        ):
    ...
    def test_dealing_to_board_turn(self):
        with patch(
            ...
            assert self.game_instance.get_board() == mock_card_options[3:6] + mock_card_options[7:8]
    ...
    def test_dealing_to_board_river(self):
        with patch(
            ...
            assert self.game_instance.get_board() == mock_card_options[3:6] + mock_card_options[7:8] + mock_card_options[9:10]
